...
import random
from traits_api import list_traits, add_trait_to_character
from abilities_api import list_abilities, add_ability_to_character, add_custom_ability
    ...
    while True:
        ...
        if choice == '1':
            ...
            if sub_choice == '1':
                ...
                from traits_api import add_custom_trait
